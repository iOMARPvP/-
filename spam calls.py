...
# @mmaahg & ICTS_930
token = "6396084862:AAFBL7OIPaDIHzlEg0SG-KtREO4NJiaCV84"
...
def start(message):
    ...
    bot.reply_to(message, f'''اهلا بك عزيزي {name} في بوت 👾 سبام مكالمات عن طريق رقم الهاتف @ICTS_930

ارسل رقم الهاتف
مع رمز الدولة متبوع بعلامة +

مثال:
+96450100756''',reply_markup=Mak().add(Btn('MHMAD',callback_data='click')))
...
def all(call):
	bot.send_message(call.message.chat.id,'''< مبرمج البوت: @mmaahg
قناة مبرمج البوت: @ICTS_930 >''')
